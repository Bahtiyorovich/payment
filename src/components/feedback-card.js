  ...
  return (
    <div className={`flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0  my-5 cursor-pointer feedback-card`}>
        ...
        <div className="flex flex-row">
            <div className="w-[53px] h-[53px] flex justify-center items-center bg-dark-gradient  rounded-full">
               <p className="font-montserrat font-semibold text-[21px] text-gradient">
